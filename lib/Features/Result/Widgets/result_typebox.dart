...
class ResultTypeBox extends StatelessWidget {
  final String? votingtypetitle;
  const ResultTypeBox({super.key, this.votingtypetitle});
    ...
    return  Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(AppStrings.resultFor, style: TextStyle(decoration: TextDecoration.none, color: AppColors.appBgColor,
                fontSize: 26 ),),
